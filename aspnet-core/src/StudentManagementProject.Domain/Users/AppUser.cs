...
namespace StudentManagementProject.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update StudentManagementProjectDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update StudentManagementProjectEfCoreEntityExtensionMappings to extend the IdentityUser entity
