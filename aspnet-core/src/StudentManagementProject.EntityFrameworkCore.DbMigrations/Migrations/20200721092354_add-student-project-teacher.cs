...
{
    public partial class addstudentprojectteacher : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NumOfStudent = table.Column<int>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TeacherProject", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TeacherProject_Project_ProjectId",
                        column: x => x.ProjectId,
                        principalTable: "Project",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TeacherProject_Teacher_TeacherId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TeacherProject_ProjectId",
                table: "TeacherProject",
                column: "ProjectId");

            migrationBuilder.CreateIndex(
                name: "IX_TeacherProject_TeacherId",
                table: "TeacherProject",
                column: "TeacherId",
                unique: true,
