...
{
    [DbContext(typeof(StudentManagementProjectMigrationsDbContext))]
    [Migration("20200721092354_add-student-project-teacher")]
    partial class addstudentprojectteacher
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StudentManagementProject.Entities.Project", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("StudentManagementProject.Entities.Student", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("StudentManagementProject.Entities.StudentProject", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("StudentManagementProject.Entities.Teacher", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("StudentManagementProject.Entities.TeacherProject", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("StudentManagementProject.Entities.StudentProject", b =>
                {
                    b.HasOne("StudentManagementProject.Entities.Project", "Project")
                        .WithMany("StudentProjects")
                        .HasForeignKey("ProjectId");

                    b.HasOne("StudentManagementProject.Entities.Student", "Student")
                        .WithOne("StudentProject")
                        .HasForeignKey("StudentManagementProject.Entities.StudentProject", "StudentId");
                });
            ...
            modelBuilder.Entity("StudentManagementProject.Entities.TeacherProject", b =>
                {
                    ...
                    b.HasOne("StudentManagementProject.Entities.Teacher", "Teacher")
                        .WithOne("TeacherProject")
                        .HasForeignKey("StudentManagementProject.Entities.TeacherProject", "TeacherId");
                });
