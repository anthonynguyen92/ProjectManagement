...
namespace ProjectManagement.Migrations
{
    ...
    [Migration("20200718183247_add_student_project_teacher")]
    partial class add_student_project_teacher
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProjectManagement.Entites.Project", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ProjectManagement.Entites.Student", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ProjectManagement.Entites.StudentProject", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ProjectManagement.Entites.Teacher", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ProjectManagement.Entites.TeacherProject", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ProjectManagement.Entites.Project", b =>
                {
                    b.HasOne("ProjectManagement.Entites.Student", null)
                        .WithMany("Projects")
                        .HasForeignKey("StudentId");

                    b.HasOne("ProjectManagement.Entites.Teacher", null)
                        .WithMany("Projects")
            ...
            modelBuilder.Entity("ProjectManagement.Entites.StudentProject", b =>
                {
                    b.HasOne("ProjectManagement.Entites.Project", "Projects")
                        .WithMany("Students")
                        .HasForeignKey("ProjectId");

                    b.HasOne("ProjectManagement.Entites.Student", "Student")
                        .WithMany()
                        .HasForeignKey("StudentId");
                });
            ...
            modelBuilder.Entity("ProjectManagement.Entites.TeacherProject", b =>
                {
                    b.HasOne("ProjectManagement.Entites.Project", "Project")
                        .WithMany("Teachers")
                        .HasForeignKey("ProjectId");

                    b.HasOne("ProjectManagement.Entites.Teacher", "Teacher")
                        .WithMany()
                        .HasForeignKey("TeacherId");
                });
