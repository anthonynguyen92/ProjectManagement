...
{
    public static class ProjectManagementEfCoreEntityExtensionMappings
    {
        private static readonly OneTimeRunner OneTimeRunner = new OneTimeRunner();

        public static void Configure()
        {
            ProjectManagementModulePropertyConfigurator.Configure();
            ...
            OneTimeRunner.Run(() =>
            {
                 ...
                 * ProjectManagementDomainObjectExtensions class.
                 *
                 * Example:
                 *
