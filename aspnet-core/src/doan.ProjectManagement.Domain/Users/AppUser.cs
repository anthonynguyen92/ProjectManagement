...
namespace doan.ProjectManagement.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update ProjectManagementDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update ProjectManagementEfCoreEntityExtensionMappings to extend the IdentityUser entity
