...
namespace StudentManagementProject
{
    public abstract class BaseAppService<
        ...
        TViewOutput,
        TEditOutput,
        TGetAllInput>: StudentManagementProjectAppService, IBaseAppService<TPrimaryKey,TCreateUpdate,TViewOutput,TEditOutput,TGetAllInput>
        ...
        where TGetAllInput : PagedAndSortedResultRequestDto
    {
        ...
        private readonly RepositoryBase<TEntity, TPrimaryKey> repository;
        public BaseAppService(RepositoryBase<TEntity,TPrimaryKey> _repository)
        {
