...
@Component({
  templateUrl: './create-edit-student-group-information.component.html',
  animations: [appModuleAnimation()]
})

export class CreateUpadteStudentGroupInformationComponent extends AppBaseComponent implements OnInit {
