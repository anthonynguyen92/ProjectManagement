    ...
    ***/
    ...
    $.extend($.fn.dataTableExt.oPagination, {
        "bootstrap_full_number": {
            "fnInit": function (oSettings, nPaging, fnDraw) {
                ...
                $(nPaging).append(
                    '<ul class="pagination">' +
                    '<li class="page-item prev disabled"><a class="page-link" href="#" title="' + oLang.sFirst + '"><i class="fa fa-angle-double-left"></i></a></li>' +
                    '<li class="page-item prev disabled"><a class="page-link" href="#" title="' + oLang.sPrevious + '"><i class="fa fa-angle-left"></i></a></li>' +
                    '<li class="page-item next disabled"><a class="page-link" href="#" title="' + oLang.sNext + '"><i class="fa fa-angle-right"></i></a></li>' +
                    '<li class="page-item next disabled"><a class="page-link" href="#" title="' + oLang.sLast + '"><i class="fa fa-angle-double-right"></i></a></li>' +
                    '</ul>'
                );
                var els = $('a', nPaging);
                $(els[0]).bind('click.DT', {
    ...
    function mapCultureToDatatablesTranslation(culture) {
        if (culture) {
			...
			return culture.displayName || "English";
		}
		
		return 'English';
    }
    */
    var translationsUrl = './assets/datatables/translations/' + ftapp.getCurrentLanguage() + '.json';
    $.ajax(translationsUrl, { async: false })
        .fail(function () {
            translationsUrl = './assets/datatables/translations/en.json';
        }).always(function () {
            $.extend(true, $.fn.dataTable.defaults, {
                language: {
                    translationsUrl
